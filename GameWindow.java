...
public class GameWindow extends JFrame implements ActionListener {
    ...
    String[] word = {"JAPAN", "QATAR", "SYRIA", "MONGOLIA", "BAHARAIN", "INDIA", "PAKISTAN", "AUSTRALIA", "AFGHANISTAN",
                     "CHINA","NIGERIA", "KOREA", "SAUDI", "CANADA", "SINGAPORE", "PORTUGAL", "ARGENTINA", "IRAQ", "IRAN", "MOROCCO"};
    ...
    public GameWindow() {
        ...
        a = new JButton("A"); b = new JButton("B"); c = new JButton("C");
        d = new JButton("D"); e = new JButton("E"); f = new JButton("F");
        g = new JButton("G"); h = new JButton("H"); i = new JButton("I");
        j = new JButton("J"); k = new JButton("K"); l = new JButton("L");
        m = new JButton("M"); n = new JButton("N"); o = new JButton("O");
        p = new JButton("P"); q = new JButton("Q"); r = new JButton("R");
        s = new JButton("S"); t = new JButton("T"); u = new JButton("U");
        v = new JButton("V"); w = new JButton("W"); x = new JButton("X");
    ...
    public void addComponent() {
        ...
        key1.add(q); key1.add(w); key1.add(e); key1.add(r); key1.add(t);
        key1.add(y); key1.add(u); key1.add(i); key1.add(o); key1.add(p);
        ...
        key2.add(a); key2.add(s); key2.add(d); key2.add(f); key2.add(g);
        key2.add(h); key2.add(j); key2.add(k); key2.add(l);
        ...
        key3.add(z); key3.add(x); key3.add(c); key3.add(v); key3.add(b);
        key3.add(n); key3.add(m);
